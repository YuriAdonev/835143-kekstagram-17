...
(function () {
  ...
  function validateHashtags() {
    ...
    if (!isHashtagMatchPattern(hashtags)) {
      return 'Каждый хэш-тег должен начинаться с символа # ' +
        'и состоять только из букв, цифр и нижнего подчеркивания (_). ' +
  ...
  form.addEventListener('submit', function (evt) {
    if (form.checkValidity()) {
      evt.preventDefault();
      document.querySelector('main').appendChild(sendMessageTemplate.cloneNode(true));
